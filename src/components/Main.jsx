          ...
          <div class="home__container container grid">
            <div class="home__data">
              <h1 class="home__title">
                ...
                <p className="presentacion">Soy Juan Elvis</p>
                <img src={img4} alt="home image" class="home__title-img-1" />
                <img src={img4} alt="home image" class="home__title-img-2" />
              </h1>

              <p class="home__description">Código limpio, mente clara</p>
...
const Container = styled.div`
  .home {
    ...
    &__img {
      ...
      filter: drop-shadow(12px 7px 1px #07ffb5);
    }
